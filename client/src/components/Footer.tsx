        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/astonearletransport" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/5 hover:bg-maroon/20 flex items-center justify-center text-white/50 hover:text-white transition-all duration-200">
              ...
              <a href="https://www.facebook.com/share/1GjU8xxZut/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/5 hover:bg-maroon/20 flex items-center justify-center text-white/50 hover:text-white transition-all duration-200">
