              ...
              <AnimatedSection delay={200}>
                <div className="space-y-6">
                  ...
                  <div className="bg-cream/50 p-7 border border-border">
                    ...
                    <div className="flex gap-3">
                      <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-charcoal/5 hover:bg-maroon/10 flex items-center justify-center text-charcoal/50 hover:text-maroon transition-all duration-200">
                      ...
                      <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-charcoal/5 hover:bg-maroon/10 flex items-center justify-center text-charcoal/50 hover:text-maroon transition-all duration-200">
